...
<body>
	...
	<table class="table table-striped" border=1>
		...
		<tr>
			...
			<td>This notice is to inform all student and teachers and
				staffs.</td>
			<td>Students,Teacher,Staffs</td>
			<td><a href="Issue.html" class="btn btn-success"><span
					class="icon-table"></span>View Full Notice</a> <a href="edit.html"
				class="btn btn-primary"><span class="icon-edit"></span> Edit</a> <a
				href="delete.html" class="btn btn-danger"><span
					class="icon-trash"></span> Delete</a></td>
		</tr>
