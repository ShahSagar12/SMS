...
<div id="user-nav" class="navbar navbar-inverse">
	<ul class="nav">
		<li class="dropdown" id="profile-messages"><a title="" href="#"
			...
			class="dropdown-toggle"><i class="fas fa-user"></i> <span
				class="text">Welcome User</span><b class="caret"></b></a>
			<ul class="dropdown-menu">
				<li><a href="userprofile"><i class="icon-user"></i> My Profile</a></li>
				<li class="divider"></li>
				<li><a href="usertasks.jsp"><i class="icon-check"></i> My Tasks</a></li>
			</ul></li>
		<li class="dropdown" id="menu-messages"><a href="messages.jsp"
			data-toggle="dropdown" data-target="#menu-messages"
			class="dropdown-toggle"><i class="fas fa-envelope"></i> <span
		...
		<li class=""><a title="" href="login.jsp"><i
				class="fas fa-sign-out-alt"></i> <span class="text">Logout</span></a></li>
	</ul>
</div>
